 ...
 */
package com.paypal.developer.jeffprestes.speaker;
    ...
    public static void speak(String text, String language)  {
        try {
            ...
            if (text.length()>42)   {
                ...
                Logger.getLogger(Speaker.class.getName()).log(Level.INFO, "Due a eSpeak bug, the text was truncated to fit 42 characters.");
            }
            
            String system = System.getProperty("os.name");
            String eSpeakLocation = "";
            Logger.getLogger(Speaker.class.getName()).log(Level.INFO, system);
            ...
            while ((line = br.readLine()) != null) {
                Logger.getLogger(Speaker.class.getName()).log(Level.INFO, line);
            }
            br.close();
            Logger.getLogger(Speaker.class.getName()).log(Level.INFO, "Speech finished.");
